  ...
  methods: [
    {
      ...
      code: function(browserName, browserVersion,
        ...
        let browserHistory = this.BrowserHistory.create();
        let dummyBrowserAPI = this.BrowserAPI.create({
          browserName, browserVersion, osName});
        let releaseDate = browserHistory
          .getReleaseDate(dummyBrowserAPI.browserKey);
