...
angular.module('confluence').component('apiCatalogTable', {
  template: require('../../static/component/api_catalog_table.html'),
  ...
  bindings: {
    ...
    browserKeys: '<',
    // browserOptions is a JSON of form {browserKey: Boolean}
    ...
    ableToDeleteBrowser: '@',
    // length is an optional Integer property that the result interface/API
    // must be available in this number of browsers.
    length: '<',
    // length is an optional Integer array property that the result
    // interface/API must be available in this these numbers of browsers.
    lengths: '<',
  },
});
